...
use TaskPlannerBundle\Entity\Priority;
...
class PriorityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $priorities = $em->getRepository('TaskPlannerBundle:Priority')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('TaskPlannerBundle\Form\PriorityType', $priority);
    ...
    {
        $deleteForm = $this->createDeleteForm($priority);
        $editForm = $this->createForm('TaskPlannerBundle\Form\PriorityType', $priority);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('priority_edit', array('id' => $priority->getId()));
        }
