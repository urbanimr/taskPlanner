...
use TaskPlannerBundle\Entity\Status;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $statuses = $em->getRepository('TaskPlannerBundle:Status')->findAll();
    ...
    {
        $status = new Status();
        $form = $this->createForm('TaskPlannerBundle\Form\StatusType', $status);
    ...
    {
        $deleteForm = $this->createDeleteForm($status);
        $editForm = $this->createForm('TaskPlannerBundle\Form\StatusType', $status);
